// 10x primitive: duolingo/dimensional-button v2
import SwiftUI
...
struct DimensionalButtonConfig {
    ...
    /// Text labels render uppercase by default — the reference app sets every
    /// dimensional CTA in caps ("CHECK", "CONTINUE"). `nil` keeps given casing.
